...
export const aiProposalJsonSchema = {
  ...
  $defs: {
    ...
    addElement: { type: "object", additionalProperties: false, required: ["id", "type", "element", "rationale"], properties: { id: { type: "string" }, type: { type: "string", const: "add_element" }, element: { $ref: "#/$defs/element" }, rationale: { type: "string" } } },
    updateElement: { type: "object", additionalProperties: false, required: ["id", "type", "target_id", "changes", "rationale"], properties: { id: { type: "string" }, type: { type: "string", const: "update_element" }, target_id: { type: "string" }, changes: { $ref: "#/$defs/changes" }, rationale: { type: "string" } } },
    removeElement: { type: "object", additionalProperties: false, required: ["id", "type", "target_id", "rationale"], properties: { id: { type: "string" }, type: { type: "string", const: "remove_element" }, target_id: { type: "string" }, rationale: { type: "string" } } },
    addRelationship: { type: "object", additionalProperties: false, required: ["id", "type", "relationship", "rationale"], properties: { id: { type: "string" }, type: { type: "string", const: "add_relationship" }, relationship: { $ref: "#/$defs/relationship" }, rationale: { type: "string" } } },
    removeRelationship: { type: "object", additionalProperties: false, required: ["id", "type", "relationship_id", "rationale"], properties: { id: { type: "string" }, type: { type: "string", const: "remove_relationship" }, relationship_id: { type: "string" }, rationale: { type: "string" } } },
